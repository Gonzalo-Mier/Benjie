...
| EK-TM4C129EXL     | or access point (AP) is also required for this example.|
| MSP-EXP430F5529LP | Note that the CC3100 uses the 2.4GHz band. If your AP  |
| MSP-EXP430FR5969LP| is dual band (i.e. supports both 2.4GHz and 5GHz bands)|
| MSP-EXP432P401RLP | you must utilize the 2.4GHz band when running this     |
|                   | application.                                           |
