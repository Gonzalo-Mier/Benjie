...
.dlls,em4f .dlls: tcpEchoCC3100.pem4f

-include package/cfg/tcpEchoCC3100_pem4f.mak
-include package/cfg/tcpEchoCC3100_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/tcpEchoCC3100_pem4f.dep
endif
tcpEchoCC3100.pem4f: package/cfg/tcpEchoCC3100_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
tcpEchoCC3100.pem4f package/cfg/tcpEchoCC3100_pem4f.c: .libraries,em4f
endif

package/cfg/tcpEchoCC3100_pem4f.c package/cfg/tcpEchoCC3100_pem4f.h package/cfg/tcpEchoCC3100_pem4f.xdl: override _PROG_NAME := tcpEchoCC3100.xem4f
package/cfg/tcpEchoCC3100_pem4f.c: package/cfg/tcpEchoCC3100_pem4f.cfg
package/cfg/tcpEchoCC3100_pem4f.xdc.inc: package/cfg/tcpEchoCC3100_pem4f.xdl
package/cfg/tcpEchoCC3100_pem4f.xdl package/cfg/tcpEchoCC3100_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/tcpEchoCC3100_pem4f.cfg
	-$(RM) package/cfg/tcpEchoCC3100_pem4f.dep
	-$(RM) package/cfg/tcpEchoCC3100_pem4f.c
	-$(RM) package/cfg/tcpEchoCC3100_pem4f.xdc.inc

clean,em4f::
	-$(RM) tcpEchoCC3100.pem4f
.executables,em4f .executables: tcpEchoCC3100.xem4f

tcpEchoCC3100.xem4f: |tcpEchoCC3100.pem4f

-include package/cfg/tcpEchoCC3100.xem4f.mak
tcpEchoCC3100.xem4f: package/cfg/tcpEchoCC3100_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armlnk -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/tcpEchoCC3100_pem4f.oem4f   package/cfg/tcpEchoCC3100_pem4f.xdl --silicon_version=7M4 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
tcpEchoCC3100.xem4f: export C_DIR=
tcpEchoCC3100.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
tcpEchoCC3100.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

tcpEchoCC3100.test test,em4f test: tcpEchoCC3100.xem4f.test

tcpEchoCC3100.xem4f.test:: tcpEchoCC3100.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 tcpEchoCC3100.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.tcpEchoCC3100.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,tcpEchoCC3100.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) tcpEchoCC3100.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
tcpEchoCC3100_pem4f.oem4f,copy : package/cfg/tcpEchoCC3100_pem4f.oem4f
tcpEchoCC3100_pem4f.sem4f,copy : package/cfg/tcpEchoCC3100_pem4f.sem4f
